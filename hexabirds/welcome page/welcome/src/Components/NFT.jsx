...
import img44 from '../assets/img/img_44.png';
import boy_img1 from '../assets/img/boy1img.png';
import img55 from '../assets/img/img77.png';
import img_img from '../assets/img/img_img.png';
import img66 from '../assets/img/img66.png';
import boy from '../assets/img/imgggg_boy.png';
        ...
        <div>
          <div>
            <div className=" position-relative div_box ms-5">
              ...
              <img className=" w-100" src={img66} alt="" />
              <img className=" position-absolute img_slider w_50  pt-5 " src={boy} alt="" />
              <h2 className=" fw_400 fs_21 ln_24 clr_white ff_Montserrat mt-5    text-center">
                Bored Ape Club
              </h2>
              <h2 className="fw_400 fs_21 ln_21 clr_white ff_Montserrat   text-center">
                XRP 0.28998
